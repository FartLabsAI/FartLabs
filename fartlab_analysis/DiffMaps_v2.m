...
eval(['map_' vfilename '= maps;'])
eval(['label_' vfilename '= label;'])
save([vfile '\map_' vfilename '.mat'],['map_' vfilename],['label_' vfilename])
% end
...
if plot_diff_maps==1
    ...
    cd(vfile)
    writerObj = VideoWriter([vfile '\' vfilename '.avi']);
